...
export default function GenerateTrip() {
    ...
    const GenerateAITrip = async () => {
        ...
        // Use OpenAI to create trip
        const completion = await openai.chat.completions.create({
            model: 'gpt-4o-2024-08-06', // Use OpenAI model
            messages: [
                {
                    role: 'developer',
    ...
    return (
        <View style={{ padding: 25, paddingTop: 75, backgroundColor: Colors.WHITE, height: '100%' }}>
            <Text style={{ fontFamily: 'roboto-bold', fontSize: 35, textAlign: 'center' }}>
                Please wait...
            </Text>
            <Text style={{ fontFamily: 'roboto-bold', fontSize: 20, textAlign: 'center', marginTop: 40 }}>
            ...
            <Text style={{ fontFamily: 'roboto-regular', fontSize: 20, color: Colors.GRAY, textAlign: 'center' }}>
                Do not go back
            </Text>
        </View>
    );

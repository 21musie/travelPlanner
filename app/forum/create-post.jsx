...
const CreatePostScreen = () => {
  ...
  const createPost = async () => {
    if (!postContent.trim() || hashtags.length === 0) {
      Alert.alert('Error', 'Please enter post content and at least one hashtag.');
      return;
    }
    ...
    try {
      ...
      Alert.alert('Error', 'There was an issue creating the Posts. Please try again.');
    }
  };
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.actionButtons}>
          <TouchableOpacity style={[styles.button, styles.cancelButton]} onPress={() => Alert.alert('Cancelled', 'You cancelled creating the post.')}>
